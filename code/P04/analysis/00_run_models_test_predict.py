...
def predicting_four_models_leaf_nodes_NL(ensemble, meta_p, the_p, pack, n_esti):
...
def predict_models(meta_m, m, meta_p, p):
    ...
    for n_esti in n_estimators:
        ...
        for spl in samples_per_leaf:
            ...
            pred_sk = predicting_four_models_leaf_nodes_NL(ensemble, meta_p, p, pack, n_esti).T
...
path_in = r"D:\PycharmProjects\IGM_PhD_Materials\data\P04\in\nl_risk_features_v1.12.csv"
path_nl_500m = r"D:\PycharmProjects\IGM_PhD_Materials\data\P04\in\nl_centroids_v1.12.csv"
...
print("Train/Test data: ", meta_m.shape, m.shape)
print("Prediction data: ", meta_p.shape, p.shape)
